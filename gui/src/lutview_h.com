...
$! VPACK Version 1.8, Wednesday, June 12, 1996, 14:26:42
$!
...
class LutAxisView : public LutView {
  ...
  public:
    	...
    	LutAxisView ( Widget, char *, Lut *, Lut*, Lut* );
	LutAxisView ( Widget, char *, Lut *);
    	virtual ~LutAxisView ();
...
class LutHorAxisView : public LutAxisView {
  ...
  public:
    	...
    	LutHorAxisView ( Widget parent, char *name, 
			Lut *lut, Lut *lut1, Lut *lut2 )
		: LutAxisView (parent, name, lut, lut1, lut2) 
			{ }

	LutHorAxisView ( Widget parent, char *name, Lut *lut)
...
class LutBox : public UIComponent {
  ...
  public:
	...
	LutBox(Widget, char *, Lut *, Lut *, Lut *);
...
class LutVerAxisView : public LutAxisView {
  ...
  public:
    	...
    	LutVerAxisView ( Widget parent, char *name, 
			Lut *lut, Lut *lut1, Lut *lut2 )
		: LutAxisView (parent, name, lut, lut1, lut2)
			{ if (_lut) _lut->attachView(this); }

	LutVerAxisView ( Widget parent, char *name, Lut *lut )
                : LutAxisView (parent, name, lut)
			{ if (_lut) _lut->attachView(this); }
...
class LutGraphView : public LutView {
  ...
  public:
	...
	LutGraphView ( Widget, char *, Lut *, Lut *, Lut * );
	LutGraphView ( Widget, char *, Lut * );
