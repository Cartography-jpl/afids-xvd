...
$! VPACK Version 1.8, Wednesday, February 15, 1995, 14:30:12
$!
...
class BasicWedgeView : public UIComponent {
  ...
  public:
	...
	BasicWedgeView ( char * name ) : UIComponent (name)  {}
...
class WedgeView : public BasicWedgeView {
  ...
  public:
	...
	WedgeView(Widget parent, char * name,  int view_height = 0, int view_width = 0 );
