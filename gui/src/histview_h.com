...
$! VPACK Version 1.8, Monday, November 18, 1996, 21:06:07
$!
...
class HistAxisView : public HistView {
  ...
  public:
    	...
    	HistAxisView ( Widget, char *, Histogram *, Histogram *, Histogram *, 
			OrientType );
...
class HistBox : public UIComponent {
  ...
  public:
	...
	HistBox(Widget, char *, Histogram *, Histogram * =NULL, Histogram* =NULL);
	~HistBox();
...
class HistGraphView : public HistView {
	...
	HistGraphView ( Widget, char *, Histogram *, Histogram *, Histogram *, 
...
class HistHorAxisView : public HistAxisView {
  ...
  public:
    	...
    	HistHorAxisView ( Widget, char *, Histogram *, Histogram *, Histogram *, OrientType );
...
class HistVerAxisView : public HistAxisView {
  ...
  public:
    	...
    	HistVerAxisView ( Widget, char *, Histogram *, Histogram *, Histogram *, 
...
class HistView : public UIComponent {
  ...
  public:
	...
	HistView ( char *name ) : UIComponent (name) { }
	virtual ~HistView() { }
...
class StatView : public HistView {
  ...
  public:
    ...
    StatView ( Widget, char *, Histogram *, Histogram *, Histogram * );
    ~StatView ();
