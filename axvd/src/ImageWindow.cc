...
Widget ImageWindow::createWorkArea( Widget parent)
{
  ...
  _latLonCmd = new LatLonBarCmd( "Map Coordinate Display", FALSE, _imageDisplayer);
  ...
  new LutToImageWidgetGlue(_lutR, _lutG, _lutB,
					        _imageView->getWidget(), True);
  new LutToImageWidgetGlue(_pseudoR,
						       _pseudoG,
						       _pseudoB,
						       _imageView->getWidget(),
						       False);
  ...
  new ImageToRangeDialogGlue(_image, rangeDialog);
