$!****************************************************************************
$!
$! Build proc for MIPL module dspwindow_h
$! VPACK Version 1.8, Tuesday, October 29, 1996, 09:44:13
$!
$! Execute by entering:		$ @dspwindow_h
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module dspwindow_h ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$!
...
$ write sys$output "Invalid argument given to dspwindow_h.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("dspwindow_h.bld") .eqs. "" then gosub Build_File
$   if (primary .eqs. " ")
$   then
$      @dspwindow_h.bld "STD"
$   else
$      @dspwindow_h.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create dspwindow_h.repack
$ DECK/DOLLARS="$ VOKAGLEVE"
$ vpack dspwindow_h.com -mixed -
	-s DspWindowBasic.h
$ Exit
$ VOKAGLEVE
$ Return
