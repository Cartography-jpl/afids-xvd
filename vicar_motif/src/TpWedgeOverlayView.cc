...
String TpWedgeOverlayView::_defaults[] = {
    "*wedgeView.scrollBarDisplayPolicy: NEVER",
    "*wedgeView.shadowThickness:        0", 
    "*wedgeView.highlightThickness:     0", 
    "*wedgeView.orientation:            HORIZONTAL", 
    "*wedgeView.nsteps:                 256",
    "*wedgeView.viewWidth:              256",
    "*wedgeView.imageWidth:             256", 
    NULL,
};

TpWedgeOverlayView::TpWedgeOverlayView(Widget parent, char *name, Cmd *cmd)
    : UIComponent(name)
{
    _cmd = cmd;
